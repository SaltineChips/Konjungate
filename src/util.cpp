...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\KONJ
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\KONJ
    // Mac: ~/Library/Application Support/KONJ
    // Unix: ~/.KONJ
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "KONJ";
#else
    fs::path pathRet;
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ...
               fprintf(ConfFile, "port=19417\n");
               fprintf(ConfFile, "rpcport=18495\n");
